    ...
    <form class="needs-validation" novalidate method="post" action="index.php">
        <div class="row g-3">
            ...
            <div class="col-sm-6">
                ...
                <input type="text" name="pubdate" class="form-control" id="pubdate" placeholder="ccyy-mm-dd" value="" required>
                <div class="invalid-feedback">
        ...
        <hr class="my-4">
        <input type="hidden" name="timeline" value="4weeks">
        <button class="w-100 btn btn-primary btn-lg" type="submit">Submit</button>
    </form>
    <a class="btn btn-dark btn-xl js-scroll-trigger" href="index.php">Back to introduction</a>
    <a class="btn btn-dark btn-xl js-scroll-trigger" href="index.php?timeline=6weeks">Go to next phase</a>
</div>
