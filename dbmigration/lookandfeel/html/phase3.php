        ...
        <div class="row g-3">
            ...
            <div class="col-12">
                ...
                <div class="input-group">
                    <textarea cols="120" rows="15" name="content" class="form-control" id="content" placeholder="Text of the article" required></textarea>
                    <div class="invalid-feedback">
                        <p>This article describes what this sample is about.</p><p>Notice how each Plugin requires a different
            ...
            <div class="col-sm-6">
                ...
                <input type="text" name="datepublished" class="form-control" id="pubdate" placeholder="ccyy-mm-dd" value="" required>
                <div class="invalid-feedback">
                    Please provide the publication date of the article.
                </div>
            </div>
            <div class="col-sm-6">
                <label for="author" class="form-label">Author's name</label>
                <input type="text" name="author" class="form-control" id="author" placeholder="Author's name" value="" required>
                <div class="invalid-feedback">
                    Please provide the name of the original author of the article.
                </div>
            </div>
        </div>

        <hr class="my-4">
        <input type="hidden" name="timeline" value="6weeks">
